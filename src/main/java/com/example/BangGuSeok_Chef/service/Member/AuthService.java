...
public class AuthService {
    ...
    public MemberResponseDto signup(MemberRequestDto memberRequestDto) {
        ...
        if (memberRequestDto.getNickname() == null || memberRequestDto.getEmail() == null || memberRequestDto.getPassword() == null || memberRequestDto.getAge() == 0 || memberRequestDto.getGender() == null) {
            throw new RuntimeException("조건을 만족하지 못하였습니다");
        }
    ...
    public TokenDto reissue(TokenRequestDto tokenRequestDto) {
        ...
        RefreshToken refreshToken = refreshTokenRepository.findBy_key(authentication.getName())
